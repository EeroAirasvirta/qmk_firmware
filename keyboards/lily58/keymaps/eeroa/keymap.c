 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, FI_QUOT,
...
/* QWERTY (Compatibility layout for custom software layout)
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  +\? |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |                    |   Y  |   U  |   I  |   O  |   P  |   '  |
 ...
 */
 ...
 [_QW_COMP] = LAYOUT(
  ...
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, FI_QUOT,
  KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L, FI_ODIA, FI_ADIA,
  KC_LSFT, FI_LABK, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   FI_DIAE,  KC_N,    KC_M, FI_COMM,  FI_DOT, FI_MINS, KC_RSFT,
                        KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC,    KC_ENT, MO(_RAISE), KC_BSPC, KC_RALT
),

/* QWERTY (Compatibility layout for custom software layout) + Alt and Cmd swapped.
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  +\? |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |                    |   Y  |   U  |   I  |   O  |   P  |   '  |
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    |      |QWERTY|Q_CO_M|Q_COMP|COLMAK|      | // Persistent
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------.    ,-------|      |QWERTY|Q_CO_M|Q_COMP|COLMAK|      | // Temporary
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RAlt |
 ...
 */
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, QWERTY,  QW_COMP_MAC, QW_COMP,      COLEMAK,      XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, DF(_QWERTY), DF(_QW_COMP_MAC), DF(_QW_COMP), DF(_COLEMAK), XXXXXXX,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  case QW_COMP:
    if (record->event.pressed) {
      set_single_persistent_default_layer(_QW_COMP);
    }
    break;
  case QW_COMP_MAC:
    if (record->event.pressed) {
      set_single_persistent_default_layer(_QW_COMP_MAC);
    }
    break;
  case COLEMAK:
    if (record->event.pressed) {
